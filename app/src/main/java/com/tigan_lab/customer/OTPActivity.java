...
public class OTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Debug Message","Class OTPActivity Started. First onCreate line 46");
        init();
    }
    private void init() {
        progressDialog = new Dialog(this);
        Log.i("Debug Message","Inside init function line 52");
    ...
    private void otpUrl() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.OTP, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.d("OTP-Value","message after the otpurl in log.d");
                System.out.println("Otp Code: "+pinview.getValue());
                Log.wtf("OTP Code: ",pinview.getValue());
                Log.d("OTP",response);
