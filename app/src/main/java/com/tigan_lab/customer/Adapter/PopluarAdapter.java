...
import static com.tigan_lab.customer.PopularServicesActivity.bottom_linearrr;
import static com.tigan_lab.customer.PopularServicesActivity.check;
import static com.tigan_lab.customer.PopularServicesActivity.tv_items;
import static com.tigan_lab.customer.PopularServicesActivity.tv_price;
...
import com.tigan_lab.customer.Add_on_Activity;
...
public class PopluarAdapter extends RecyclerView.Adapter<PopluarAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout linear_add, linear_count,l1_rating,viewdetails,clock,lratiingss;
        ...
        public MyViewHolder(View view) {
            ...
            lratiingss=view.findViewById(R.id.linear_ratedd);
...
/*        holder.rating.setOnClickListener(new View.OnClickListener() {
        ...
        holder.lratiingss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, ReviewRatingActivity.class);
                intent.putExtra("service_id",lists.getService_id());
